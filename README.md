...
功能与 `main` 分支上的 1.20.1 / Forge 版**完全一致**，只是把平台从 Forge 迁到 NeoForge、把对接的上游版本换成 1.21.1 的 AE2 19.2.x 与 GTM 1.21.1-7.0.x。

> 需要 **Minecraft 1.20.1 / Forge** 版本？切到 **`main` 分支**即可。
...
本分支的仓库根目录就是完整的 Gradle 工程（1.20.1 / Forge 版的工程在 `main` 分支的根目录，两边互不影响）：
